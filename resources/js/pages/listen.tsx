    ...
    return (
        <Main>
            <section className="mb-12">
                ...
                <p className="page-subtitle">Immerse yourself in our dark, atmospheric soundscapes</p>
            </section>
            ...
            <section className="mb-12">
                ...
                <div className="card">
                    <div className="grid items-center gap-6 md:grid-cols-2">
                        <div>
                            <img src={getImageUrl('/images/album-cover.jpg')} alt="Latest Album" className="w-full rounded-lg shadow-lg" />
                        </div>
                        <div>
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                    {[
                        ...
                        <div key={i} className="card">
                            <div className="mb-4 aspect-square rounded-lg bg-[var(--muted)]"></div>
