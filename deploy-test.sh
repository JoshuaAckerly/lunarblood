#!/bin/bash
# Test Server Deployment Script for Lunar Blood
...
>>>>>>> 462a4d3 (chore: deploy latest changes (2026-02-20))
...
if command -v supervisorctl &> /dev/null; then
    ...
    sudo supervisorctl restart lunarblood-worker:* 2>/dev/null || echo "No queue workers configured yet"
fi
...
echo "=================================="
echo "🌐 Your site should now be live at test-lunarblood.yourdomain.com"
